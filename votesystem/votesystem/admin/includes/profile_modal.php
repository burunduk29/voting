    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <hr>
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">Повторите пароль:</label>
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-success btn-flat" name="save"><i class="fa fa-check-square-o"></i> Сохранить</button>
            	</form>
          	</div>
        </div>
    </div>
