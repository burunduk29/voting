    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #d8d1bd ;color:black ; font-size: 15px; font-family:Times ">
            <div class="modal-header">
              <button type="button" class=" btn btn-close btn-curve pull-right"  data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Добавить кандидата</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Пост</label>
                ...
                <div class="form-group">
                    <label for="platform" class="col-sm-3 control-label">Описание кандидата</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #d8d1bd ;color:black ; font-size: 15px; font-family:Times ">
            <div class="modal-header">
              <button type="button" class=" btn btn-close btn-curve pull-right"  data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Изменить кандидата</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="candidates_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Должность</label>
                ...
                <div class="form-group">
                    <label for="edit_platform" class="col-sm-3 control-label">Описание</label>
