...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: #F1E9D2 " >
    ...
    <section class="content-header" style="color:black ; font-size: 17px; font-family:Times">
      ...
      <ol class="breadcrumb" style="color:black ; font-size: 17px; font-family:Times">
        ...
        <li class="active" style="color:black ; font-size: 17px; font-family:Times" >Информационная панель</li>
      </ol>
    </section>
      ...
      <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box" style="background-color: Red">
            <div class="inner" style="background-color:#B0C4DE ;color:black ; font-size:15px;" >
              ...
              <p > <b >Количество должностей </b> </p>
            </div>
            <div class="icon">
              <i class="fa fa-cog"></i>
            </div>
            
            <a href="positions.php" class="small-box-footer " style="background-color:#4682B4 ; color:black ; font-size:18px">Больше информации <i class="fa fa-arrow-right"></i></a>
          </div>
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box bg-green">
            ...
            <a href="candidates.php" class="small-box-footer" style="background-color:	#8B4513 ;color:black ; font-size: 18px"> Больше информации <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="inner" style="background-color: #B59B91 ;color:black ; font-size:15px; font-family:Times">
              ...
              <p> <b >Количество избирателей </b></p>
            </div>
            <div class="icon">
              <i class="fa fa-users"></i>
            </div>
            <a href="voters.php" class="small-box-footer "style="background-color:  #96837E ;color:black ; font-size: 18px">Больше информации <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
  ...
  <div class="small-box bg-red">
    <div class="inner" style="background-color: #778899; color: black; font-size: 15px; font-family: Times">
      <?php
        $sql = "SELECT COUNT(DISTINCT voters_id) AS voters_count FROM votes";
        $query = $conn->query($sql);

        if ($query) {
          // Получаем количество уникальных voters_id, которые проголосовали
          $row = $query->fetch_assoc();
          echo "<h3>".$row['voters_count']."</h3>";
        } else {
      ...
      ?>
      <p><b>Количество проголосовавших</b></p>
    </div>
    <div class="icon">
      <i class="fa fa-edit"></i>
    </div>
    <a href="votes.php" class="small-box-footer" style="background-color: #2F4F4F; color: black; font-size: 18px">Больше информации <i class="fa fa-arrow-right"></i></a>
  </div>
</div>
