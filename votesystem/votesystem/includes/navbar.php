  ...
  <nav class="navbar navbar-static-top" style="background-color:#717A83 ">
    <div class="container" style="background-color:#717A83 ">
      <div class="navbar-header" style="background-color:#717A83 ">
        <a href="#" class="navbar-brand" style="background-color:#717A83 ;color:black ; font-size: 22px; font-family:Times  ">
        <img src="images/logo.png" alt="Logo" style="height: 35px; display: inline-block; vertical-align: middle; margin-right: 10px; ">  
        <b>Система <b>онлайн-</b>голосования</a>
      ...
      <div class="navbar-custom-menu"  >
        <ul class="nav navbar-nav"  >
          ...
          <li><a href="logout.php"> <b style="color:black ; font-size: 22px;> <i class=fa fa-sign-out"> </b></i> <b style="color:black ; font-size: 22px; font-family:Times  " > Выйти </b></a></li>  
        </ul>
      </div>
      <!-- /.navbar-custom-menu -->
    </div>
