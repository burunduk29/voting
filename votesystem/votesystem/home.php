				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		<div class="text-center" style="color:black ; font-size: 35px; font-family:Times" >
					    		<h3>Вы уже проголосовали на этих выборах.</h3>
					    		<a href="#view" data-toggle="modal" class="btn btn-curve btn-primary btn-lg" style="background-color: #4682B4 ;color:black ; font-size: 22px; font-family:Times">Посмотреть биллютень</a>
					    	</div>
				    		<?php
				    	}
				    	else{
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										$instruct = ($row['max_vote'] > 1) ? 'You may select up to '.$row['max_vote'].' candidates' : 'Выберите кандидата';
														...
														<div class="box-body" >
															<p>'.$instruct.'
																<span class="pull-right">
																	...
																	<button type="button" class="btn btn-success btn-sm btn-curve reset" style="background-color:#9CD095 ;color:black ; font-size: 12px; font-family:Times"  data-desc="'.slugify($row['description']).'"><i class="fa fa-refresh"></i> Сбросить</button>
																</span>
															</p>
